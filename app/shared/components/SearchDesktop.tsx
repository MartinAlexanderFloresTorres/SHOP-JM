  ...
  return (
    <>
      <form className="flex items-center gap-2 relative w-[400px] h-fit mx-auto">
        <input type="text" placeholder="Buscar" className="w-full pl-4 py-3 pr-14 font-normal text-gray-500 placeholder:text-gray-400 border border-gray-200 rounded-full focus-visible:outline-none focus-visible:border-gray-300 transition-colors" />
